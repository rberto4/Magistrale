...
public class Locale extends Treno{

    final static int MAX_PASSEGGERI = 200;
    private ArrayList<String> wFermateIntermedie;

    public Locale(String nome,String partenza, String destinazione, ArrayList<String> fermateIntermedie) {
