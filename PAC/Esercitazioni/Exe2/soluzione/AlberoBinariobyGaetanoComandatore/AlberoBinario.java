...
public interface AlberoBinario {
	...
	public int level();  // restituisce il livello dell'albero
	public int level(NodoBinario u); // restituisce il livello del singolo nodo
	public int altezza (); // restituisce l'altezza dell'albero
	public int numNodiInterni(); //restituisce il num di nodi interni
	public int numFoglie(); // restituisce il num di foglie
	public boolean equals(NodoBinario v); //rende true se l'albero è identico a v
	public void eliminaFoglieUguali(); //elimina le foglie che hanno un valore uguale al fratello
	public boolean search(Object o); //rende true se l'albero contiene l'oggetto o
