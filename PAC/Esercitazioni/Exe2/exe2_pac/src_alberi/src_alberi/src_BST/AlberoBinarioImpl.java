...
public class AlberoBinarioImpl implements AlberoBinario {
     ...
     * <code>r</code>.
     *
     * @return il numero di nodi presenti nell'albero radicato in
     * <code>r</code>.
     */
	...
	private int altezza(NodoBinario n){

		int sx = 0;
		int dx = 0;
		
		 if(n.sinistro!=null) {
			sx= altezza(n.sinistro);
			}
		else if (n.destro!=null) {
			dx = altezza(n.destro);
			}
		...
		public int numFoglie() {
			// se non ho radice -> albero vuoto -> non ho foglie.
	...
	private int numFoglie(NodoBinario n) {
		int nsx, ndx;
		nsx = 0;
		ndx = 0;
		if (n.sinistro ==null && n.destro==null)
			{return 1;
			// radice presente, ce una foglia, 
			}
		if (n.sinistro!=null)
			{nsx = numFoglie(n.sinistro);}
		if (n.destro!=null)
			{ndx = numFoglie(n.destro);}
	...
	private int numNodiInterni (NodoBinario n){
		int sx = 0;
		int dx = 0;

		if (n.sinistro != null) {
			sx = numNodiInterni(n.sinistro);
		}
		if (n.destro != null) {
			sx = numNodiInterni(n.destro);
		}
		return sx + dx +1;
		
		// +1 perche c'e anche la radice 
	}
}
