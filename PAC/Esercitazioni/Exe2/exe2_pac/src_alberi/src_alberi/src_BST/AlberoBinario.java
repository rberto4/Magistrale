...
public interface AlberoBinario {
	...
	*/
	...
	restituisce la profondità (o livello) di un nodo.
	Ricorda che la profondità della radice è 0 e quella di un nodo diverso dalla
	radice è quella del padre del nodo, incrementata di 1
