...
public class AlberoBinarioDemo{
	public static void main(String argc[]){
		...
		System.out.println("alb1.innestaDes(nodo2,alb6)"); alb1.innestaDes(nodo2,alb6);
					...
					System.out.println("altezza alb1: " + alb1.altezza());
					System.out.println("altezza alb2: " + alb2.altezza());
					System.out.println("altezza alb3: " + alb3.altezza());
					System.out.println("altezza alb4: " + alb4.altezza());
